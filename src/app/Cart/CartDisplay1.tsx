...
const CartDisplay1 = ({
  ...
  return (
    <>
      <div className="w-full p-2 grid grid-cols-[repeat(4,minmax(0,1fr))] mt-10  border-[1px] border-t-zinc-800 border-b-zinc-800 lg:rounded-md lg:border-zinc-900/50 md:max-w-7xl mx-auto ">
